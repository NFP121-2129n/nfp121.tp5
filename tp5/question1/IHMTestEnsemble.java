...
public class IHMTestEnsemble extends JFrame{
    ...
    class ButtonListener implements ActionListener {
        public void actionPerformed(ActionEvent e){
            ...
            if (src == button1)unionActionPerformed(e);
            else if (src == button2) intersectionActionPerformed(e);
            else if (src == button3) differenceActionPerformed(e);
            else diffSymetriqueActionPerformed(e);                
        }
    }
    ...
    private void differenceActionPerformed(ActionEvent evt) {// GEN-FIRST:event_differenceActionPerformed
    ...
    private void intersectionActionPerformed(ActionEvent evt) {// GEN-FIRST:event_intersectionActionPerformed
        // Add your handling code here:
        Ensemble<String> e1 = getSet(textField1);
        Ensemble<String> e2 = getSet(textField2);
    ...
    private void unionActionPerformed(ActionEvent evt) {// GEN-FIRST:event_unionActionPerformed
        Ensemble<String> e1 = getSet(textField1);
        Ensemble<String> e2 = getSet(textField2);
        textField3.setText(e1.union(e2).toString());
    }// GEN-LAST:event_unionActionPerformed

    private void diffSymetriqueActionPerformed(ActionEvent evt) {// GEN-FIRST:event_button4ActionPerformed
        // Add your handling code here:
        Ensemble<String> e1 = getSet(textField1);
        Ensemble<String> e2 = getSet(textField2);
