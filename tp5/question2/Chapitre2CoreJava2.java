...
public class Chapitre2CoreJava2 {
    ...
    public static List<String> listeDesMots() {
        ...
        while (iterator.hasNext()) {
            liste.add((String) iterator.next());
        }
    ...
    public static Map<String, Integer> occurrencesDesMots(List<String> liste) {
        ...
        while (iterator.hasNext()) {
            String iteratorNext = iterator.next();
            if (table.containsKey(iteratorNext)) {
                table.replace(iteratorNext, table.get(iteratorNext) + 1);
            } else {
                table.put(iteratorNext, 1);
            }
        }
        return table;
    }
